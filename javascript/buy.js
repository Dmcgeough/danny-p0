...
//maybe use the whole list and find a way to cycle through
// var addButton1 = document.querySelector("button[name='stock1Add']");
// this line will GRAB the button
// addButton1.addEventListener('click', () => {   function code goes here }) ;
// that line will DO SOMETHIGN when the button is CLICKED