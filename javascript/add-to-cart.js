...
var book0 = ["The Girl with the Dragon Tattoo", 7.99 ];
var book1 = ["Never Go Back", 7.99];
var book2 = ["Best Served Cold", 13.99];
var book3 = ["Cronkite", 19.99];
var book4 = ["50 Shades of Grey", 9.99];
var book5 = ["The President is Missing", 17.99];
var book6 = ["Shelter in Place", 14.99];
var book7 = ["The Soul of America", 17.99];
var book8 = ["The Fallen", 14.99];
var book9 = ["Something in the Water", 13.99];
var book10 = ["The Grey Ghost", 13.99];
var book11 = ["The Death of Mrs. Westaway", 12.99];

var bookArray = [book0, book1, book2, book3, book4, book5, book6, book7, book8, book9, book10, book11];
